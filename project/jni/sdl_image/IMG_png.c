...
int IMG_InitPNG()
{
	if ( lib.loaded == 0 ) {
		...
		lib.png_create_read_struct =
			(png_const_structp (*) (png_const_charp, png_voidp, png_error_ptr, png_error_ptr))
		...
		lib.png_destroy_read_struct =
			(void (*) (png_const_structpp, png_infopp, png_infopp))
		...
		lib.png_get_IHDR =
			(png_uint_32 (*) (png_const_structp, png_infop, png_uint_32 *, png_uint_32 *, int *, int *, int *, int *, int *))
		...
		lib.png_get_channels =
			(png_byte (*) (png_const_structp, png_infop))
		...
		lib.png_get_PLTE =
			(png_uint_32 (*) (png_const_structp, png_infop, png_colorp *, int *))
		...
		lib.png_get_valid =
			(png_uint_32 (*) (png_const_structp, png_infop, png_uint_32))
		...
		lib.png_read_image =
			(void (*) (png_const_structp, png_bytepp))
		...
		lib.png_read_info =
			(void (*) (png_const_structp, png_infop))
		...
		lib.png_set_read_fn =
			(void (*) (png_const_structp, png_voidp, png_rw_ptr))
		...
		lib.png_set_longjmp_fn =
			(jmp_buf * (*) (png_const_structp, png_longjmp_ptr, size_t))
